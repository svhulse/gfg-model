...
nc_path = './data/nocov_gs_costs.p'
gs_path = './data/cov_gs_costs.p'
gv_path = './data/cov_gv_costs.p'

allele_freqs_nc, _, _ = load_data(nc_path, 'c_s', 'c_g')
allele_freqs_gs, _, _ = load_data(gs_path, 'c_s', 'c_g') 
allele_freqs_gv, _, _ = load_data(gv_path, 'v', 'c_g')
...
fig.savefig('fig_1.svg', bbox_inches='tight', pad_inches=0.1)